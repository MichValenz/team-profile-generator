...
Roster.prototype.employeeRoster = function () {
  inquirer
    .prompt([{
      ...
      choices: ["Intern", "Engineer", "Manager", "Cancel"],
      ...
      .prompt(
          {
              ...
              name: "nextStep",
              choices: ["Add Another Employee", "Complete Roster"],
          })
          .then((nextStepInput) => {
              if (nextStepInput === "Add Another Employee") {
               this.employeeRoster();
              } else if (nextStepInput === "Complete Roster") {
    ...
    .then((engineerAnswers) => {
      ...
      this.engineer = this.employeesArr[0];
        ...
        inquirer
          ...
          .then((nextStepAnsw) => {
            if (nextStepAnsw === "Add Another Employee") {
              return this.employeeRoster();
            } else if (nextStepAnsw === "Complete Roster") {
              console.log("Roster completed.");
            }
          });
};
